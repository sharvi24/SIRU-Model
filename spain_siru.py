...
Original file is located at
    https://colab.research.google.com/drive/1w-weCdOS4gAyzIWq2t_kr7t7jCYL-Q54
"""
...
#spain.savefig('spain.png')
#files.download('spain.png')
...
spain45.savefig('spain45.png')
files.download('spain45.png')
...
plt.title("SIRU with public health measures: Spain")
plt.show()

fig.savefig('ItalySIRUwMeasures.png')
files.download('ItalySIRUwMeasures.png')