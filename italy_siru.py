...
Original file is located at
    https://colab.research.google.com/drive/1rpcD_w8malmkUlbf3-4A3kkmrMcsmHmg
"""
...
italy45.savefig('italy45.png')
#files.download('italy45.png')
...
plt.title("SIRU: Italy")
plt.show()

fig.savefig('ISIRUwoMeasures.png')
files.download('ISIRUwoMeasures.png')
...
plt.title("SIRU with public health measures: Italy")
plt.show()

fig.savefig('nItalySIRUwMeasures.png')
files.download('nItalySIRUwMeasures.png')